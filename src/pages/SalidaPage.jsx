...
const SalidaPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (materialSeleccionado.stock < cantidad) {
            openModal("Error", "Stock insuficiente");
            return;
        }

        actualizarStock(materialId, cantidad, "SALIDA");
    ...
    return (
        <div className="movimientos">
            <h2 className="movimientos__title">Nota de Salida</h2>
